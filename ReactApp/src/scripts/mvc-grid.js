        ...
        reload: function (grid) {
            ...
            if (grid.sourceUrl) {
                $.ajax({
                    ...
                    if (grid.reloadEnded) {
                        if (newGrid.name != '') {
                            $("#" + newGrid.name).prev('.loader').hide();
                            $("#" + newGrid.name).show();
                            if (!$("#" + newGrid.name + " table td").hasClass("mvc-grid-empty"))
                                $("<tr class='gridFooter'></tr>").insertAfter("#" + newGrid.name + " table tbody tr:last-child");
                        }

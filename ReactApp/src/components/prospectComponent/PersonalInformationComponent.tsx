                ...
                <div className="row form-group">
                    ...
                    <div className="form-group col-sm-1">
                        ...
                        <input type="text" className="form-control" name="middleInitial"
                            placeholder="MI" value={this.props.middleInitial} max-length="1"
                           onChange={this.handleUserInput} />
                    </div>
                        ...
                        <div className="row">
                            ...
                            <div className="form-group col-sm-4">
                                ...
                                <input type="text" className="form-control" name="homeAddressZipCode"
                                    placeholder="ZipCode" max-length="5" onChange={this.handleUserInput} value={this.props.homeAddressZipCode} />
                            </div>
                        </div>
                        ...
                        <div className="row">
                            ...
                            <div className="form-group col-sm-4">
                                ...
                                <input type="text" className="form-control" name="mailingAddressZipCode"
                                    placeholder="ZipCode" max-length="5" onChange={this.handleUserInput} value={this.props.mailingAddressZipCode} />
                            </div>
                        </div>

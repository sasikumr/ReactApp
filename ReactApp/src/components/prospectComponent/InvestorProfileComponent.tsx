...
*/
class InvestorProfile extends Component<any,any> {
    constructor(props) {
        super(props);
        ...
        return (<div>
            ...
            <div className="row">
                ...
                <div className="form-group col-sm-2">
                    ...
                    <input type="text" name="employerZipCode" max-length="5" className="form-control" onChange={this.handleUserInput} value={this.props.employerZipCode} />
                </div>
            </div>
            <div className="row">
                <div className="form-group col-sm-2">

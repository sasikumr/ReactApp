...
import InvestorProfile from '../../components/ProspectComponent/InvestorProfileComponent';
...
export const InvestorProfileContainer = connect(mapStateToProps, mapDispatchToProps)(InvestorProfile);